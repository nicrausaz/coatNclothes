                                ...
                                <!--[if (!mso)&(!IE)]><!--><div style="border-top: 0px solid #E8E8E8; border-left: 0px solid #E8E8E8; border-bottom: 0px solid #E8E8E8; border-right: 0px solid #E8E8E8; padding-top:20px; padding-bottom:25px; padding-right: 0px; padding-left: 0px;"><!--<![endif]-->
                                    ...
                                    <div class="">
                                        ...
                                        <div style="color:#555555;line-height:120%;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                                            <div style="font-size:12px;line-height:14px;color:#555555;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;text-align:left;"><ul style="list-style-type: square;"><li style="font-size: 12px; line-height: 14px;"><span style="font-size: 18px; line-height: 21px;"><strong>Commande numéro : {{$obj->id}}</strong></span></li><li style="font-size: 12px; line-height: 14px;"><span style="font-size: 18px; line-height: 21px;"><strong>Etat :  En attente de vérification <br></strong></span></li></ul><p style="margin: 0;font-size: 12px;line-height: 14px">&#160;<br></p><p style="margin: 0;font-size: 12px;line-height: 14px">&#160;<br></p><p style="margin: 0;font-size: 12px;line-height: 14px">&#160;<br></p></div>
                                            <div>Un pdf contenant la confirmation des articles commandés se trouve en pièce jointe</div>
                                        </div>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                    </div>
